...
const GroeneHaven : React.FC = () =>{
    return(
        <>
                <div id='groenehaven' className='container mx-auto p-8 dark-green m-auto argent grid md:grid-cols-2 grid-cols-1 gap-8'>
                    <h2 className="md:text-5xl text-4xl text-center border-b mb-8 font-semibold col-span-2">Groene haven voor jongeren</h2>
                    <div className="mb-8 mx-auto col-span-2 border-b">
                    ...
                    <img src={bijenkorven} alt="bijenkorven in de tuin" className="w-[350px] rounded m-auto mb-8"/>
                    <div className="mx-auto">
                        <h3 className="text-3xl font-semibold mb-8">Wat gaan we doen?</h3>
